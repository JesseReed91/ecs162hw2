...
stopButton.onclick = function () {
  ...
  if (times.length > 0) {
    ...
    resultString =
      "No results recorded. Hit the Enter key to submit your answers.";
    categoryString = "";
  }
...
/***** FUNCTIONS ******/
/*
 * This function refreshes the numbers and starts the timer
 */
 ...
 */
/*
 * This function checks if the answer is correct and updates the UI accordingly
 */
...
/*
* This function takes the mean time as an argument and returns how skilled the user is
at mental math
*/
